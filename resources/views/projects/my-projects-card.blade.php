<div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-50 shadow row-span-2 sm:col-span-2 lg:col-span-3">
    <div class="px-4 py-5 sm:px-6 flex justify-between bg-white">
        <h3 class="text-lg font-semibold leading-6 text-gray-900 dark:text-gray-200">My Latest Projects</h3>
        <x-secondary-action-button href="{{ route('projects.index') }}">View all</x-secondary-action-button>
    </div>
